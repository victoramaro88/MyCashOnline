    ...
    SalvarNovoRegistro() {
      ...
      this.http.ManterUsuario(this.dadosUsuarioModel).subscribe((ret: string) => {
        if (ret !== undefined) {
          ...
          detail: 'Foi enviado um e-mail com um link para que você possa ativar a sua conta, após ativá-la, basta fazer o login e acessar o sistema.'});
          scrollTo(0, 0);
          this.btnCadastroHome = true;
          // setTimeout(() => {
          //   this.msgs = [];
          // }, 3000);
        }
